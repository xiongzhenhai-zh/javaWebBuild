package com.careJava.code.dao.impl;
...
public class ArticleDAO implements IArticleDAO {	
	...
	public String save(Article article) throws Exception {	
		return (String) hibernateTemplate.save(article);	
	}
	...
	public List<Article> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<Article> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
	...
	public List querySQL(final String sql,final Map<String, Object> value,final int page,final int rows) throws Exception {
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				Query query = session.createQuery(hql).addEntity(Article.class);;
				if (value!=null) {
					Set<String> keySet = value.keySet();  
		            for (String string : keySet) {  
		                Object obj = value.get(string);  
