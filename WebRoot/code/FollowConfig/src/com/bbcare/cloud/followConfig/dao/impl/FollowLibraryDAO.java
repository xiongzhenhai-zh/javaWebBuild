...
@Repository	
public class FollowLibraryDAO implements IFollowLibraryDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowLibrary followLibrary) throws Exception {	
		return (String) hibernateTemplate.save(followLibrary);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowLibrary.class, id));	
	}	
	
   	public void update(FollowLibrary followLibrary) throws Exception {	
		hibernateTemplate.update(followLibrary);	
	}
	
    public FollowLibrary get(String id) throws Exception {	
		return hibernateTemplate.get(FollowLibrary.class, id);	
	}
	...
	public List<FollowLibrary> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowLibrary> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowLibrary>)criteria.list();
			}
		});	
	}	
