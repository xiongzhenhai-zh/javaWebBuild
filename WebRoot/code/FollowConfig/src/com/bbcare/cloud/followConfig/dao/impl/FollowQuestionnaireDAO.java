...
@Repository	
public class FollowQuestionnaireDAO implements IFollowQuestionnaireDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowQuestionnaire followQuestionnaire) throws Exception {	
		return (String) hibernateTemplate.save(followQuestionnaire);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowQuestionnaire.class, id));	
	}	
	
   	public void update(FollowQuestionnaire followQuestionnaire) throws Exception {	
		hibernateTemplate.update(followQuestionnaire);	
	}
	
    public FollowQuestionnaire get(String id) throws Exception {	
		return hibernateTemplate.get(FollowQuestionnaire.class, id);	
	}
	...
	public List<FollowQuestionnaire> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowQuestionnaire> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowQuestionnaire>)criteria.list();
			}
		});	
	}	
