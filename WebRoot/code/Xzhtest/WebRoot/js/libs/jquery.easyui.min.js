...
},beforePageText:"第",afterPageText:"页/共{pages}页",displayMsg:"当前显示第{from}条至第{to}条记录，共{total}条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
_9c0(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确认",buttons:[{text:function(_9d5){
