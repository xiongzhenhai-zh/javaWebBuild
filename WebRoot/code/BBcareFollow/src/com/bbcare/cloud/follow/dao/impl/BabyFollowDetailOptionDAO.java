...
@Repository	
public class BabyFollowDetailOptionDAO implements IBabyFollowDetailOptionDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowDetailOption babyFollowDetailOption) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowDetailOption);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowDetailOption.class, id));	
	}	
	
   	public void update(BabyFollowDetailOption babyFollowDetailOption) throws Exception {	
		hibernateTemplate.update(babyFollowDetailOption);	
	}
	
    public BabyFollowDetailOption get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowDetailOption.class, id);	
	}
	...
	public List<BabyFollowDetailOption> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowDetailOption> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowDetailOption>)criteria.list();
			}
		});	
	}	
