...
@Repository	
public class ContentClassDAO implements IContentClassDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(ContentClass contentClass) throws Exception {	
		return (String) hibernateTemplate.save(contentClass);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(ContentClass.class, id));	
	}	
	
   	public void update(ContentClass contentClass) throws Exception {	
		hibernateTemplate.update(contentClass);	
	}
	
    public ContentClass get(String id) throws Exception {	
		return hibernateTemplate.get(ContentClass.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<ContentClass> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<ContentClass> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<ContentClass>)criteria.list();
			}
		});	
	}	
