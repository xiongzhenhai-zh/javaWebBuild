...
@Repository	
public class FollowContentDAO implements IFollowContentDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowContent followContent) throws Exception {	
		return (String) hibernateTemplate.save(followContent);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowContent.class, id));	
	}	
	
   	public void update(FollowContent followContent) throws Exception {	
		hibernateTemplate.update(followContent);	
	}
	
    public FollowContent get(String id) throws Exception {	
		return hibernateTemplate.get(FollowContent.class, id);	
	}
	...
	public List<FollowContent> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowContent> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowContent>)criteria.list();
			}
		});	
	}	
