...
@Repository	
public class FollowTaskDAO implements IFollowTaskDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowTask followTask) throws Exception {	
		return (String) hibernateTemplate.save(followTask);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowTask.class, id));	
	}	
	
   	public void update(FollowTask followTask) throws Exception {	
		hibernateTemplate.update(followTask);	
	}
	
    public FollowTask get(String id) throws Exception {	
		return hibernateTemplate.get(FollowTask.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<FollowTask> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowTask> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowTask>)criteria.list();
			}
		});	
	}	
