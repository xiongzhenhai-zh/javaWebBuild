...
@Repository	
public class ModelClassDAO implements IModelClassDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(ModelClass modelClass) throws Exception {	
		return (String) hibernateTemplate.save(modelClass);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(ModelClass.class, id));	
	}	
	
   	public void update(ModelClass modelClass) throws Exception {	
		hibernateTemplate.update(modelClass);	
	}
	
    public ModelClass get(String id) throws Exception {	
		return hibernateTemplate.get(ModelClass.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<ModelClass> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<ModelClass> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<ModelClass>)criteria.list();
			}
		});	
	}	
