...
@Repository	
public class BabyFollowDetailDAO implements IBabyFollowDetailDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowDetail babyFollowDetail) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowDetail);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowDetail.class, id));	
	}	
	
   	public void update(BabyFollowDetail babyFollowDetail) throws Exception {	
		hibernateTemplate.update(babyFollowDetail);	
	}
	
    public BabyFollowDetail get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowDetail.class, id);	
	}
	...
	public List<BabyFollowDetail> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowDetail> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowDetail>)criteria.list();
			}
		});	
	}	
