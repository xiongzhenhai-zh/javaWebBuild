...
public class TriggerDAO implements ITriggerDAO {	
	...
	public String save(Trigger trigger) throws Exception {	
		return (String) hibernateTemplate.save(trigger);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(Trigger.class, id));	
	}	
	
   	public void update(Trigger trigger) throws Exception {	
		hibernateTemplate.update(trigger);	
	}
	
    public Trigger get(String id) throws Exception {	
		return hibernateTemplate.get(Trigger.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<Trigger> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<Trigger> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
