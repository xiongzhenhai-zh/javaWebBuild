...
@Repository	
public class ContentTypeDAO implements IContentTypeDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(ContentType contentType) throws Exception {	
		return (String) hibernateTemplate.save(contentType);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(ContentType.class, id));	
	}	
	
   	public void update(ContentType contentType) throws Exception {	
		hibernateTemplate.update(contentType);	
	}
	
    public ContentType get(String id) throws Exception {	
		return hibernateTemplate.get(ContentType.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<ContentType> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<ContentType> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<ContentType>)criteria.list();
			}
		});	
	}	
