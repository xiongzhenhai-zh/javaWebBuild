...
@Repository	
public class FollowTaskTypeDAO implements IFollowTaskTypeDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowTaskType followTaskType) throws Exception {	
		return (String) hibernateTemplate.save(followTaskType);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowTaskType.class, id));	
	}	
	
   	public void update(FollowTaskType followTaskType) throws Exception {	
		hibernateTemplate.update(followTaskType);	
	}
	
    public FollowTaskType get(String id) throws Exception {	
		return hibernateTemplate.get(FollowTaskType.class, id);	
	}
	...
	public List<FollowTaskType> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowTaskType> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowTaskType>)criteria.list();
			}
		});	
	}	
