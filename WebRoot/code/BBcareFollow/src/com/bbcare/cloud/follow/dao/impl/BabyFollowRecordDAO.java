...
@Repository	
public class BabyFollowRecordDAO implements IBabyFollowRecordDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowRecord babyFollowRecord) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowRecord);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowRecord.class, id));	
	}	
	
   	public void update(BabyFollowRecord babyFollowRecord) throws Exception {	
		hibernateTemplate.update(babyFollowRecord);	
	}
	
    public BabyFollowRecord get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowRecord.class, id);	
	}
	...
	public List<BabyFollowRecord> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowRecord> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowRecord>)criteria.list();
			}
		});	
	}	
