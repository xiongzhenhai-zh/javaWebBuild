...
@Repository	
public class ExecutiveTemplateDAO implements IExecutiveTemplateDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(ExecutiveTemplate executiveTemplate) throws Exception {	
		return (String) hibernateTemplate.save(executiveTemplate);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(ExecutiveTemplate.class, id));	
	}	
	
   	public void update(ExecutiveTemplate executiveTemplate) throws Exception {	
		hibernateTemplate.update(executiveTemplate);	
	}
	
    public ExecutiveTemplate get(String id) throws Exception {	
		return hibernateTemplate.get(ExecutiveTemplate.class, id);	
	}
	...
	public List<ExecutiveTemplate> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<ExecutiveTemplate> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<ExecutiveTemplate>)criteria.list();
			}
		});	
	}	
