...
@Repository	
public class DoctorQuestionModuleAdviceDAO implements IDoctorQuestionModuleAdviceDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(DoctorQuestionModuleAdvice doctorQuestionModuleAdvice) throws Exception {	
		return (String) hibernateTemplate.save(doctorQuestionModuleAdvice);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(DoctorQuestionModuleAdvice.class, id));	
	}	
	
   	public void update(DoctorQuestionModuleAdvice doctorQuestionModuleAdvice) throws Exception {	
		hibernateTemplate.update(doctorQuestionModuleAdvice);	
	}
	
    public DoctorQuestionModuleAdvice get(String id) throws Exception {	
		return hibernateTemplate.get(DoctorQuestionModuleAdvice.class, id);	
	}
	...
	public List<DoctorQuestionModuleAdvice> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<DoctorQuestionModuleAdvice> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<DoctorQuestionModuleAdvice>)criteria.list();
			}
		});	
	}	
