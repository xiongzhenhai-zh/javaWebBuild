...
@Repository	
public class BabyFollowSchemeTaskDAO implements IBabyFollowSchemeTaskDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowSchemeTask babyFollowSchemeTask) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowSchemeTask);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowSchemeTask.class, id));	
	}	
	
   	public void update(BabyFollowSchemeTask babyFollowSchemeTask) throws Exception {	
		hibernateTemplate.update(babyFollowSchemeTask);	
	}
	
    public BabyFollowSchemeTask get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowSchemeTask.class, id);	
	}
	...
	public List<BabyFollowSchemeTask> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowSchemeTask> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowSchemeTask>)criteria.list();
			}
		});	
	}	
