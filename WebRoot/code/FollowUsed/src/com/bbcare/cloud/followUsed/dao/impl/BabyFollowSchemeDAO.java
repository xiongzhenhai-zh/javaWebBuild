...
@Repository	
public class BabyFollowSchemeDAO implements IBabyFollowSchemeDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowScheme babyFollowScheme) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowScheme);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowScheme.class, id));	
	}	
	
   	public void update(BabyFollowScheme babyFollowScheme) throws Exception {	
		hibernateTemplate.update(babyFollowScheme);	
	}
	
    public BabyFollowScheme get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowScheme.class, id);	
	}
	...
	public List<BabyFollowScheme> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowScheme> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowScheme>)criteria.list();
			}
		});	
	}	
