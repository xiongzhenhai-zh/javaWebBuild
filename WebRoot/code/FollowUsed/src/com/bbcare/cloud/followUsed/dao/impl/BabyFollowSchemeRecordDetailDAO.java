...
@Repository	
public class BabyFollowSchemeRecordDetailDAO implements IBabyFollowSchemeRecordDetailDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(BabyFollowSchemeRecordDetail babyFollowSchemeRecordDetail) throws Exception {	
		return (String) hibernateTemplate.save(babyFollowSchemeRecordDetail);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(BabyFollowSchemeRecordDetail.class, id));	
	}	
	
   	public void update(BabyFollowSchemeRecordDetail babyFollowSchemeRecordDetail) throws Exception {	
		hibernateTemplate.update(babyFollowSchemeRecordDetail);	
	}
	
    public BabyFollowSchemeRecordDetail get(String id) throws Exception {	
		return hibernateTemplate.get(BabyFollowSchemeRecordDetail.class, id);	
	}
	...
	public List<BabyFollowSchemeRecordDetail> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<BabyFollowSchemeRecordDetail> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<BabyFollowSchemeRecordDetail>)criteria.list();
			}
		});	
	}	
