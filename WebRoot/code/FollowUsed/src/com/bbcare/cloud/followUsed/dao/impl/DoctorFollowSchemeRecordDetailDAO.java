...
@Repository	
public class DoctorFollowSchemeRecordDetailDAO implements IDoctorFollowSchemeRecordDetailDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(DoctorFollowSchemeRecordDetail doctorFollowSchemeRecordDetail) throws Exception {	
		return (String) hibernateTemplate.save(doctorFollowSchemeRecordDetail);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(DoctorFollowSchemeRecordDetail.class, id));	
	}	
	
   	public void update(DoctorFollowSchemeRecordDetail doctorFollowSchemeRecordDetail) throws Exception {	
		hibernateTemplate.update(doctorFollowSchemeRecordDetail);	
	}
	
    public DoctorFollowSchemeRecordDetail get(String id) throws Exception {	
		return hibernateTemplate.get(DoctorFollowSchemeRecordDetail.class, id);	
	}
	...
	public List<DoctorFollowSchemeRecordDetail> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<DoctorFollowSchemeRecordDetail> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<DoctorFollowSchemeRecordDetail>)criteria.list();
			}
		});	
	}	
