...
@Repository	
public class DoctorFollowSchemeRecordDAO implements IDoctorFollowSchemeRecordDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(DoctorFollowSchemeRecord doctorFollowSchemeRecord) throws Exception {	
		return (String) hibernateTemplate.save(doctorFollowSchemeRecord);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(DoctorFollowSchemeRecord.class, id));	
	}	
	
   	public void update(DoctorFollowSchemeRecord doctorFollowSchemeRecord) throws Exception {	
		hibernateTemplate.update(doctorFollowSchemeRecord);	
	}
	
    public DoctorFollowSchemeRecord get(String id) throws Exception {	
		return hibernateTemplate.get(DoctorFollowSchemeRecord.class, id);	
	}
	...
	public List<DoctorFollowSchemeRecord> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<DoctorFollowSchemeRecord> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<DoctorFollowSchemeRecord>)criteria.list();
			}
		});	
	}	
