...
@Repository	
public class FollowUserDAO implements IFollowUserDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowUser followUser) throws Exception {	
		return (String) hibernateTemplate.save(followUser);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowUser.class, id));	
	}	
	
   	public void update(FollowUser followUser) throws Exception {	
		hibernateTemplate.update(followUser);	
	}
	
    public FollowUser get(String id) throws Exception {	
		return hibernateTemplate.get(FollowUser.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<FollowUser> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowUser> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowUser>)criteria.list();
			}
		});	
	}	
