package com.bbcare.cloud.followScheme.dao.impl;
...
@Repository	
public class FollowQueueDAO implements IFollowQueueDAO {	
	
	@Autowired	
	private HibernateTemplate hibernateTemplate;	
	
	public String save(FollowQueue followQueue) throws Exception {	
		return (String) hibernateTemplate.save(followQueue);	
	}
	  
    public void delete(String id) throws Exception {	
		hibernateTemplate.delete(hibernateTemplate.get(FollowQueue.class, id));	
	}	
	
   	public void update(FollowQueue followQueue) throws Exception {	
		hibernateTemplate.update(followQueue);	
	}
	
    public FollowQueue get(String id) throws Exception {	
		return hibernateTemplate.get(FollowQueue.class, id);	
	}
	
    @SuppressWarnings({"unchecked", "rawtypes" })	
	public List<FollowQueue> list(final DetachedCriteria dc,final int page,final int rows) throws Exception {	
		return hibernateTemplate.executeFind( new  HibernateCallback(){
			public List<FollowQueue> doInHibernate(Session session)  throws  SQLException,
			HibernateException {
				...
				return (List<FollowQueue>)criteria.list();
			}
		});	
	}	
