...
public class TestConf {
	...
	private static List<Model> initModels(Project project) {
		...
		// 模型列表
		Model group = new Model(getId(), "User", "用户", "uuid", project);
		group.addAttribute(new ModelAttribute(getId(), "username", "账号", "String"));
		group.addAttribute(new ModelAttribute(getId(), "password", "密码", "String"));
	...
	public static Project getProject() {
		Project project = new Project("123456", "BBcarePlat", "BBcare管理平台", new Frame(getId(), "ssh", "SSH"),
