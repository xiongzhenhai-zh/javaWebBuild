...
public class BBCareAdminData {
	...
	private static List<Model> initModels(Project project) {
		...
		Model group = new Model(getId(),"Group","组织","uuid",project);
		group.addAttribute(new ModelAttribute(getId(), "code", "权限编码", "String"));
		group.addAttribute(new ModelAttribute(getId(), "name", "权限名称", "String"));
		group.addAttribute(new ModelAttribute(getId(), "images", "介绍图片", "String"));
		group.addAttribute(new ModelAttribute(getId(), "order", "产品排序", "String"));
		group.addAttribute(new ModelAttribute(getId(), "note", "产品简介", "String"));
		group.addAttribute(new ModelAttribute(getId(), "detail", "产品详情", "String"));
		...
		account.addAttribute(new ModelAttribute(getId(), "icon", "图标", "String"));
		account.addAttribute(new ModelAttribute(getId(), "isAutoLogin", "自动登陆", "Boolean"));
		
		Model company = new Model(getId(),"Role","角色","uuid",project);
		...
		Model news = new Model(getId(),"Auth","权限","uuid",project);
		...
		Model productItem = new Model(getId(),"Nav","菜单","uuid",project);
		...
		Model hiring = new Model(getId(),"Server","服务","uuid",project);
		...
		Model partner = new Model(getId(),"Doctor","医生","uuid",project);
