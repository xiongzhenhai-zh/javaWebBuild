...
public class FollowStatistics {
	...
	private static List<Model> initModels(Project project) {
		...
		// 模型列表
		Model statisticsFollowAddUser  = new Model(getId(), "StatisticsFollowAddUser", "统计随访添加会员", "uuid", project);
		statisticsFollowAddUser.addAttribute(new ModelAttribute(getId(),"createTime", "创建时间", "Date"));
		statisticsFollowAddUser.addAttribute(new ModelAttribute(getId(),"type","类型","String"));
		statisticsFollowAddUser.addAttribute(new ModelAttribute(getId(),"status","状态","String"));
		statisticsFollowAddUser.addAttribute(new ModelAttribute(getId(),"userId","患者Id","String"));
		statisticsFollowAddUser.addAttribute(new ModelAttribute(getId(),"note","备注","String"));

		Model statisticsFollowLoseUser  = new Model(getId(), "StatisticsFollowLoseUser", "统计随访丢失会员", "uuid", project);
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"createTime", "创建时间", "Date"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"loseTime","丢失时间","Date"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"type","类型","String"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"reason","原因","String"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"status","状态","String"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"userId","患者Id","String"));
		statisticsFollowLoseUser.addAttribute(new ModelAttribute(getId(),"note","备注","String"));
		
		
		Model statisticsFollowSoonLoseUser  = new Model(getId(), "StatisticsFollowSoonLoseUser", "统计随访即将丢失会员", "uuid", project);
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"createTime", "创建时间", "Date"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"type","类型","String"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"reason","原因","String"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"loseTime","即将丢失时间","Date"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"status","状态","String"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"userId","患者Id","String"));
		statisticsFollowSoonLoseUser.addAttribute(new ModelAttribute(getId(),"note","备注","String"));
		...
		// 添加关系
		// 添加模型
		models.add(statisticsFollowAddUser);
		models.add(statisticsFollowLoseUser);
		models.add(statisticsFollowSoonLoseUser);
		return models;
	}
	...
	public static Project getProject() {
		Project project = new Project("123456", "followQueue", "BBcare管理平台", new Frame(getId(), "sh", "SH"),
