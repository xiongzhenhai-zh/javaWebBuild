...
public class FollowQueue {
	...
	private static List<Model> initModels(Project project) {
		...
		// 模型列表
		Model followQueue  = new Model(getId(), "FollowQueue", "随访队列", "uuid", project);
		followQueue.addAttribute(new ModelAttribute(getId(), "name", "队列名称", "String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"masterType","所属人类型","String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"masterName","所属人名称","String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"masterId","所属人Id","Integer"));
		followQueue.addAttribute(new ModelAttribute(getId(),"introduction","简介","String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"note","备注","String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"status","队列状态","String"));
		followQueue.addAttribute(new ModelAttribute(getId(),"targerNumber","目标人数","Integer"));
		followQueue.addAttribute(new ModelAttribute(getId(),"usedNumber","已用人数","Integer"));
		followQueue.addAttribute(new ModelAttribute(getId(),"createTime","创建时间","Date"));
